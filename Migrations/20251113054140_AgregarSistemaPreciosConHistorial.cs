        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipoAplicacion = table.Column<int>(type: "int", nullable: false),
                    ValorCambio = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    AlcanceJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ListasAfectadasJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Estado = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PriceChangeBatches", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValorPermitido = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, "ELEC", true, new DateTime(2025, 11, 13, 5, 41, 39, 433, DateTimeKind.Utc).AddTicks(7757), "System", "Productos electrónicos", false, "Electrónica", null, null, null },
                    { 2, true, "FRIO", true, new DateTime(2025, 11, 13, 5, 41, 39, 433, DateTimeKind.Utc).AddTicks(7762), "System", "Heladeras, freezers y aire acondicionado", false, "Refrigeración", null, null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, "SAM", new DateTime(2025, 11, 13, 5, 41, 39, 442, DateTimeKind.Utc).AddTicks(2482), "System", "Electrónica y electrodomésticos", false, "Samsung", "Corea del Sur", null, null, null },
                    { 2, true, "LG", new DateTime(2025, 11, 13, 5, 41, 39, 442, DateTimeKind.Utc).AddTicks(2486), "System", "Electrónica y electrodomésticos", false, "LG", "Corea del Sur", null, null, null },
                    { 3, true, "WHI", new DateTime(2025, 11, 13, 5, 41, 39, 442, DateTimeKind.Utc).AddTicks(2488), "System", "Electrodomésticos", false, "Whirlpool", "Estados Unidos", null, null, null }
                });

            migrationBuilder.CreateIndex(
                name: "IX_AccionesModulo_Activa",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccionesModulo_ModuloId_Clave",
                table: "AccionesModulo",
                columns: new[] { "ModuloId", "Clave" },
                unique: true,
                filter: "IsDeleted = 0");

            migrationBuilder.CreateIndex(
                name: "IX_AccionesModulo_Orden",
                table: "AccionesModulo",
                column: "Orden");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ModulosSistema_Activo",
                table: "ModulosSistema",
                column: "Activo");

            migrationBuilder.CreateIndex(
                name: "IX_ModulosSistema_Categoria",
                table: "ModulosSistema",
                column: "Categoria");

            migrationBuilder.CreateIndex(
                name: "IX_ModulosSistema_Clave",
                table: "ModulosSistema",
                column: "Clave",
                unique: true,
                filter: "IsDeleted = 0");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RolPermisos_ClaimValue",
                table: "RolPermisos",
                column: "ClaimValue");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RolPermisos_RoleId_ModuloId_AccionId",
                table: "RolPermisos",
                columns: new[] { "RoleId", "ModuloId", "AccionId" },
                unique: true,
                filter: "IsDeleted = 0");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SolicitudesAutorizacion_FechaResolucion",
                table: "SolicitudesAutorizacion",
                column: "FechaResolucion");

            migrationBuilder.CreateIndex(
                name: "IX_SolicitudesAutorizacion_TipoUmbral",
                table: "SolicitudesAutorizacion",
                column: "TipoUmbral");

            migrationBuilder.CreateIndex(
                name: "IX_SolicitudesAutorizacion_UsuarioAutorizador",
                table: "SolicitudesAutorizacion",
                column: "UsuarioAutorizador");

            migrationBuilder.CreateIndex(
                name: "IX_SolicitudesAutorizacion_UsuarioSolicitante",
                table: "SolicitudesAutorizacion",
                column: "UsuarioSolicitante");

            migrationBuilder.CreateIndex(
                name: "IX_UmbralesAutorizacion_Activo",
                table: "UmbralesAutorizacion",
                column: "Activo");

            migrationBuilder.CreateIndex(
                name: "IX_UmbralesAutorizacion_Rol",
                table: "UmbralesAutorizacion",
                column: "Rol");

            migrationBuilder.CreateIndex(
                name: "IX_UmbralesAutorizacion_TipoUmbral",
                table: "UmbralesAutorizacion",
                column: "TipoUmbral");
